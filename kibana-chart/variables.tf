...
variable "es_host" {
  ...
  type        = string
  default     = "https://elasticsearch-master.svc.cluster.local:9200"
}

variable "es_certificate_secret" {
  description = "Elastic search certificate secret"
  type        = string
  default     = "elasticsearch-master-certs"
}

variable "es_ca_file" {
  description = "Elastic search certificate ca file name"
  type        = string
  default     = "ca.crt"
}
variable "es_master_pass" {
  description = "Elastic search master password secret"
  type        = string
